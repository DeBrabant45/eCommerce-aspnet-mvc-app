...
public class AppDbInitializer
{
    public static void Seed(IApplicationBuilder applicationBuilder)
    {
        using (var serviceScope = applicationBuilder.ApplicationServices.CreateScope())
        {
            ...
            AddMovies(context);
            AddActorsMovies(context);
        }
    }

    private static void AddCinemas(AppDbContext? context)
    {
    ...
    private static void AddActors(AppDbContext? context)
    {
    ...
    private static void AddProducers(AppDbContext? context)
    {
    ...
    private static void AddActorsMovies(AppDbContext? context)
    {
